...
urlpatterns = [
    path('<uuid:user_uuid>/', login_required(ProfileDetailView.as_view()), name='detail',),
    path('update/', login_required(ProfileUpdateView.as_view()), name='update'),
    path('<uuid:user_uuid>/followers/', login_required(FollowersView.as_view()), name='followers'),
    path('<uuid:user_uuid>/following/', login_required(FollowingView.as_view()), name="following"),
    path('<uuid:user_uuid>/follow/', toggle_follow, name='toggle_follow'),
